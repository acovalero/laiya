            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>@lang('quickadmin.room_types.fields.room-number')</th>
                            <td field-key='room_number'>{{ $room->room_number }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.room_types.fields.floor')</th>
                            <td field-key='floor'>{{ $room->floor }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.room_types.fields.status')</th>
                            <td field-key='status'>{{ $room->status }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.room_types.fields.description')</th>
